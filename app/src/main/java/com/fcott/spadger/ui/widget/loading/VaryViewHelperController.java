 ...
 */
package com.fcott.spadger.ui.widget.loading;
...
public class VaryViewHelperController {
    ...
    public void showNetworkError(View.OnClickListener onClickListener) {
        ...
        textView.setText(helper.getContext().getResources().getString(R.string.load_nonetwork_tip));
    ...
    public void showError(String errorMsg, View.OnClickListener onClickListener) {
        ...
        if (!TextUtils.isEmpty(errorMsg)) {
            ...
            textView.setText(helper.getContext().getResources().getString(R.string.load_failed_tip));
        }
    ...
    public void showEmpty(String emptyMsg, View.OnClickListener onClickListener) {
        ...
        if (!TextUtils.isEmpty(emptyMsg)) {
            ...
            textView.setText(helper.getContext().getResources().getString(R.string.load_empty_tip));
        }
