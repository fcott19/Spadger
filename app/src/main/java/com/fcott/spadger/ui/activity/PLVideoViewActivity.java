...
public class PLVideoViewActivity extends VideoPlayerBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMediaController.setFullScreenListener(new View.OnClickListener() {
        ...
        mMediaController.setChangeScreenScaleListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//        Toast.makeText(this, message, Toast.LENGTH_LONG).show();
    ...
    protected Handler mHandler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message msg) {
            ...
            if (mIsActivityPaused || !NetWorkUtil.isLiveStreamingAvailable()) {
                finish();
                return;
            }
            if (!NetWorkUtil.isNetworkAvailable(PLVideoViewActivity.this)) {
                sendReconnectMessage();
                return;
            }
            mVideoView.setVideoPath(mVideoPath);
